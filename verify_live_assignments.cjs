...
(async () => {
    console.log('=== 🛰️ LIVE LEAD ASSIGNMENT AUDIT ===');
    ...
    console.log('| Created At (UTC) | Lead Name | Assigned To | Team | Target Booster? | Source |');
    console.log('|---|---|---|---|---|---|');
    ...
    console.log(`\nAccuracy of last 20 leads: ${(targetCount / 20) * 100}% to Target Boosters`);
})();
