        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900">Call / WhatsApp</h3>
                <p className="text-slate-600">+91 7009064038</p>
                <p className="text-xs text-slate-400 mt-1">Mon-Sat, 10 AM - 6 PM</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900">zirakpur, punjab</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">10:00 AM - 06:00 PM IST</p>
              </div>
            </div>
          </div>
        </div>
