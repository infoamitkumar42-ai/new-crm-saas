...
// ... I will read full data from a file or truncated for test. 
// Wait, I need to process ALL. I'll paste the full block again.

const FULL_DATA = `job_person	Anvesh Udrala	p:+919104571837	Dahod
student	Ashvin Chauhan	p:+919099427364	Melan
job_person	Dhruv Bhavsar	p:9265812521	Ahemdabad
job_person	Milan Patel	p:8401551457	Surat
others	Suheb Kaji	p:+919714048074	mahUVA
...
async function runFinal() {
    console.log("🔥 FINAL ATTEMPT - ONE BY ONE INSERT...");
    ...
    for (const line of lines) {
        ...
        if (error) {
            if (error.code === '23505') { // Unique Violation
                // console.log(`   🟡 Skipped (Duplicate): ${finalPhone}`);
                skipped++;
            } else {
            ...
            console.log(`   🟢 Inserted: ${finalPhone} -> ${parts[1]}`);
