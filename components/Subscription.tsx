    ...
    boost: [
      {
        ...
        features: [
          { text: '15 Leads/Day', icon: Target, highlight: true },
          { text: '105 Total Leads', icon: TrendingUp, highlight: true },
          { text: '8 Replacement Leads Included', icon: RefreshCw, highlight: true },
      ...
      },
      {
        ...
        features: [
          { text: '17 Leads/Day', icon: Target, highlight: true },
          { text: '120 Total Leads', icon: TrendingUp, highlight: true },
