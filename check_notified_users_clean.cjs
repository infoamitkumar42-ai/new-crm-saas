...
async function checkNotifiedUsersClean() {
    console.log("🔍 Fetching UNIQUE Users Notified TODAY (Clean)...");
    ...
    Object.entries(userCount)
        ...
        .forEach(([uid, count]) => {
            ...
            console.log(`- ${user.name} (${user.email}): ${count} Notifs`);
        });
}

checkNotifiedUsersClean();
