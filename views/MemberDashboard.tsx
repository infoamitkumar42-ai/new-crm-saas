...
// ============================================================
// WHATSAPP BRAND ICON (lucide mein brand icons nahi hote — official glyph inline SVG)
// ============================================================
                ...
                return (
                  <div key={lead.id} className="p-3 sm:p-4 hover:bg-slate-50/50 transition-colors">
                        ...
                        {lead.source && !['Night_Backlog', 'Night_Queue', 'Fresh', 'Queued', 'New', 'Assigned'].includes(lead.source) && (
                          <div className="mt-1">
                            <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[10px] font-semibold border ${
                              lead.source?.toLowerCase().includes('snapchat')
                    ...
                    <div className="flex items-stretch gap-2 mb-3">
                      <a
                        href={`tel:${lead.phone}`}
                        className="flex-1 flex items-center justify-center gap-1.5 bg-blue-50 text-blue-600 border border-blue-200 py-2.5 rounded-xl font-bold text-[13px] hover:bg-blue-100"
                      >
                        <Phone size={16} />
                        Call
                      </a>
                      ...
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 bg-[#25D366] text-white py-2.5 rounded-xl font-bold text-[13px] shadow-sm hover:bg-[#1fb857]"
                      >
                      ...
                      <button
                        ...
                        className="w-[52px] flex flex-col items-center justify-center gap-0.5 bg-white border border-slate-200 text-slate-500 rounded-xl hover:bg-slate-50"
                      >
                        <StickyNote size={15} />
                        <span className="text-[9px] font-semibold tracking-wide">Note</span>
                      </button>

                      <button
                        onClick={() => { setShowReportModal(lead); setReportReason(''); }}
                        className="w-[52px] flex flex-col items-center justify-center gap-0.5 bg-white border border-red-200 text-red-500 rounded-xl hover:bg-red-50"
                      >
                        <Flag size={15} />
                        <span className="text-[9px] font-semibold tracking-wide">Report</span>
                      </button>
                    </div>
