...
lines.forEach(line => {
    ...
    if (parts.length >= 9) {
        const quota = parseInt(parts[6]) || 0;
...
console.log('--- SUM FROM USER MESSAGE TEXT ---');
console.log('Total Lines Parsed:', validLines);
console.log('Sum of Feb_Total_Quota:', sumQuota);
console.log('Sum of Feb_Leads_Used:', sumUsed);
console.log('Sum of Pending_Feb_Quota:', sumPending);
console.log('Calculated Goal (Used + Pending):', sumUsed + sumPending);
