-- ============================================================================
-- 🛠️ FINAL SYNC: BYPASS TRIGGERS AND FIX ATOMIC FUNCTION
-- ============================================================================

BEGIN;

-- 1. Temporarily Disable Quota Triggers to allow Sync
ALTER TABLE leads DISABLE TRIGGER trg_check_limit_insert;
ALTER TABLE leads DISABLE TRIGGER trg_check_limit_update;

-- 2. Redefine assign_lead_atomically (POPULATING BOTH COLUMNS)
...
BEGIN
    ...
    -- 4. Insert the lead (NOW WITH BOTH user_id and assigned_to)
    INSERT INTO leads (
...
-- 3. SYNC EXISTING LEADS FOR TODAY (Bypassing Triggers)
UPDATE leads 
