    ...
    monthly: [
      {
        ...
        features: [
          { text: '5 Leads/Day', icon: Target, highlight: true },
          { text: '50 Total Leads', icon: TrendingUp, highlight: true },
          { text: '5 Replacement Leads Included', icon: RefreshCw, highlight: true },
          { text: '10 Day Campaign', icon: Clock, highlight: false },
        ],
        comparison: [
      ...
      },
      {
        ...
        features: [
          ...
          { text: '10 Replacement Leads Included', icon: RefreshCw, highlight: true },
          { text: '15 Day Campaign', icon: Clock, highlight: false },
        ],
        comparison: [
      ...
      },
      {
        ...
        features: [
          { text: '8 Leads/Day', icon: Target, highlight: true },
          { text: '160 Total Leads', icon: TrendingUp, highlight: true },
          { text: '16 Replacement Leads Included', icon: RefreshCw, highlight: true },
          { text: '20 Day Campaign', icon: Clock, highlight: false },
        ],
        comparison: [
    ...
    boost: [
      {
        ...
        features: [
          { text: '12 Leads/Day', icon: Target, highlight: true },
          { text: '92 Total Leads', icon: TrendingUp, highlight: true },
      ...
      },
      {
        ...
        features: [
          { text: '14 Leads/Day', icon: Target, highlight: true },
          { text: '108 Total Leads', icon: TrendingUp, highlight: true },
          { text: '10 Replacement Leads Included', icon: RefreshCw, highlight: true },
          { text: '7 Day Campaign', icon: Clock, highlight: false },
        ],
        comparison: [
