...
export const ENV = {
  ...
  APPS_SCRIPT_URL: safeEnv.VITE_APPS_SCRIPT_URL || "https://script.google.com/macros/s/AKfycbwCky1SbW_SvqyGvaoCxGR7SPYTbkSpIP7_XWkcqKcBNXao3eeOnky3ao-3DXjJUFJW/exec",
