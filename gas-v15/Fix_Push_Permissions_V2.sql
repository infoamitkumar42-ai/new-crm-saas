-- ============================================================================
-- 🔧 FIX PUSH SUBSCRIPTIONS PERMISSIONS (V2 - Safe Mode)
-- ============================================================================
...
-- 5. Grant Sequence Permissions (Generic/Safe)
-- This covers any serial/identity columns without guessing the name
