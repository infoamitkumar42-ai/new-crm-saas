-- ============================================================================
-- ADMIN DASHBOARD RPC FUNCTION UPDATE (Phase 86)
-- ============================================================================
-- Adding daily_limit, daily_limit_override, and leads_today to user_activities
    ...
    SELECT json_build_object(
        'user_stats', (
            SELECT json_build_object(
                ...
                'logins_today', SUM(COALESCE((SELECT COUNT(DISTINCT id) FROM auth.sessions WHERE user_id = users.id AND created_at::date = CURRENT_DATE), 0)),
        ...
        'user_activities', (
            SELECT COALESCE(json_agg(
                json_build_object(
                    ...
                    'login_count', (SELECT COUNT(*) FROM auth.sessions WHERE user_id = users.id AND created_at::date = CURRENT_DATE),
