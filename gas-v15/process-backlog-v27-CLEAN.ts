...
serve(async (req) => {
    ...
    try {
        ...
        console.log('🧹 Backlog Sweeper v27 (CLEAN) - FAIR BATCH MODE');
        ...
        for (const lead of leads) {
            ...
            const eligible = users.filter(u => {
                ...
                // Team/Manager Logic (If applicable)
                if (lead.source?.includes("Himanshu") && u.id !== "79c67296-b221-4ca9-a3a5-1611e690e68d") return false;
