...
export const ENV = {
  // Public keys are fine to have fallbacks for dev
  ...
  // Your Google Script URL (Safe to expose)
  ...
  // Razorpay Key ID is public (Safe)
  RAZORPAY_KEY_ID: safeEnv.VITE_RAZORPAY_KEY_ID || "rzp_live_RnAEaa2JKAP8Ow",
  
  // 🛑 DANGER: Secrets should NOT be hardcoded here. Keep them empty strings.
  // Vercel will inject them automatically on the server side.
  RAZORPAY_KEY_SECRET: safeEnv.VITE_RAZORPAY_KEY_SECRET || "", 
  RAZORPAY_WEBHOOK_URL: safeEnv.VITE_RAZORPAY_WEBHOOK_URL || "https://leadflow.com/api/razorpay-webhook",
  RAZORPAY_WEBHOOK_SECRET: safeEnv.VITE_RAZORPAY_WEBHOOK_SECRET || "" 
};